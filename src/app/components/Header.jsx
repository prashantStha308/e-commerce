    ...
    <header>
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div
                    className={`fixed inset-0 flex items-center bg-white bg-opacity-35 justify-center transition-opacity duration-300 z-10 ${
                        isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
                    }`}
                    >
                    <div className="bg-red p-6 rounded-lg shadow-lg max-w-sm w-full">

                    <ul className="h-full w-40 fixed top-0 right-0 pt-20 font-medium dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
